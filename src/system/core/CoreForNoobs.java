 ...
 * @author JANSEN ANG
 */
public class CoreForNoobs extends JFrame  implements ISexyTabsDemo , ITabbedPaneWindow , 
        ITabbedPaneWindowFactory , ITabFactory  {
    private CoreForNoobs core;
    private Dropdown dd;
	...
	{
		setTitle( "JS Smart Choice Supermarket POS and Inventory System for Employees" );
		...
		JMenuBar menuBar = new JMenuBar();
                ...
                JMenuItem pos = new JMenuItem(new POSAction());
	...
	private void updateTitle( )
	{
		...
		tab.setContent( pur );
         ...
         private class POSAction extends AbstractAction
        {   
            public POSAction(){
                super("Point of Sale");
            }
	...
	public void start()
	{
		CoreForNoobs core = new CoreForNoobs();
