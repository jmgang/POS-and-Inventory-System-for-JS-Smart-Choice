...
public void comboFilter(String enteredText) {
    ...
    String str="SELECT * FROM SellingArea WHERE ProductName LIKE '"+enteredText+"%'"
            + " or Barcode LIKE '"+enteredText+"%'";

     ResultSet rs= Helper.getData(con, str);
     while(rs.next())
     {

      str1=rs.getString("ProductName");
      str2 = rs.getString("Barcode");
      filterArray.add(str1);
      filterArray.add(str2);
