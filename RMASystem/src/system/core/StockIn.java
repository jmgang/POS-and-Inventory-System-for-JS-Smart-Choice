...
import static system.core.StockIn.fromSplit;
 ...
 * @author JANSEN
 */
public class StockIn extends javax.swing.JPanel implements DocumentListener {
    ...
    public StockIn() {
        initComponents();
        String query = 
                    "Select * from StockIn where ProductId like '%"+searchtf.getText()+"%' or "
                 ...
                 + " Cost like '"+searchtf.getText()+"%'  "
                 + " or Total like '%"+searchtf.getText()+"%' or Supplier like '%"+searchtf.getText()+"%' "
                + " ";
        findUsers(query);
    ...
    private void initComponents() {
        ...
        fromDate.setDateFormatString("MM/d/yy");

        fromText.setText("From:");

        toText.setText("To:");

        toDate.setDateFormatString("MM/d/yy");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(fromDate, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(toText)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(toDate, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(130, 130, 130)
      ...
      public ArrayList<StockInBean> ListUsers(String query)
    {   
         ResultSet rs = Helper.getData(con, query);
        ArrayList<StockInBean> usersList = new ArrayList<StockInBean>();
        try{
            StockInBean sib;
            ...
            {
               sib = new StockInBean(
                               rs.getInt("ProductId"), rs.getString("Barcode"),
                               rs.getString("ProductName"), rs.getString("ProductDesc"), rs.getString("Category"), 
                               rs.getInt("Quantity"), rs.getFloat("Cost"), rs.getFloat("Total"), 
                               rs.getString("Supplier"), rs.getTimestamp("Date"));
                usersList.add(sib);
            }
    ...
    {   
        ...
        ArrayList<StockInBean> users = ListUsers(query);
        ...
        model.setColumnIdentifiers(new Object[]{"ProductId", "Barcode", "Product Name", 
                                                "Product Description", "Category", "Quantity", "Cost", 
                                                "Total", "Supplier", "Date"});
        ...
        {   
            ...
            row[5] = users.get(i).getQuantity();
            row[6] = users.get(i).getCost();
            row[7] = users.get(i).getTotal();  
            row[8] = users.get(i).getSupplier();
    ...
    public void setDateTable(){
     ...
     public void changeTable(){
          ...
          Date tdate = toDate.getDate();
             if(fdate != null && tdate != null){
                    ...
                    System.out.println(fromSplit[0] + " " + toSplit[0]);
                     String query = 
                    "Select * from StockIn where cast(dbo.StockIn.Date as date ) between '"+fromSplit[0]+"' and "
                             + " '"+toSplit[0]+"' and " +
        " (ProductId like '%"+searchtf.getText()+"%' or  Barcode like '%"+searchtf.getText()+"%' or"
                  ...
                  + "Cost like '%"+searchtf.getText()+"'or Total like '%"+searchtf.getText()+"%' or "
                             + "Supplier like '%"+searchtf.getText()+"%' )   ";
    ...
    public void insertUpdate(DocumentEvent e) {
      ...
      if(fromSplit != null && toSplit != null){
        ...
        " (ProductId like '%"+searchtf.getText()+"%' or  Barcode like '%"+searchtf.getText()+"%' or"
         ...
         String query = 
          "Select * from StockIn where ProductId like '%"+searchtf.getText()+"%' or  Barcode like '%"+searchtf.getText()+"%' or"
                  + " ProductName like '%"+searchtf.getText()+"%' or ProductDesc like '%"+searchtf.getText()+"%' or "
                  + "Category " 
                  + " like '%"+searchtf.getText()+"%' or Quantity like '%"+searchtf.getText()+"' or  "
                  + "Cost like '%"+searchtf.getText()+"'or Total like '%"+searchtf.getText()+"%' or "
    ...
    public void removeUpdate(DocumentEvent e) {
        ...
        " (ProductId like '%"+searchtf.getText()+"%' or  Barcode like '%"+searchtf.getText()+"%' or"
          ...
          String query = "Select * from StockIn where ProductId like '%"+searchtf.getText()+"%' or  Barcode like '%"+searchtf.getText()+"%' or"
                  + " ProductName like '%"+searchtf.getText()+"%' or ProductDesc like '%"+searchtf.getText()+"%' or "
                  + "Category " 
                  + " like '%"+searchtf.getText()+"%' or Quantity like '%"+searchtf.getText()+"' or  "
                  + "Cost like '%"+searchtf.getText()+"'or Total like '%"+searchtf.getText()+"%' or "
