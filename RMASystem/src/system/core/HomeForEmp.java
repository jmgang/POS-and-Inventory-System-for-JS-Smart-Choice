 ...
 * @author JANSEN
 */
public class HomeForEmp extends javax.swing.JFrame {
   ...
   public static enum Mode{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeForEmp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeForEmp().setVisible(true);
            }
        });
    }
