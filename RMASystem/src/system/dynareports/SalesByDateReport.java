...
public class SalesByDateReport extends BaseSalesByDate {
    
    private boolean productId, productDesc, barcode, cat, quantity, cost, sales, profit, 
                    a4por, a4land, legpor, legland, name;
    private String title, subTitle;
    
    
    public SalesByDateReport(){}
        
        public SalesByDateReport(String title, String subTitle,  
                boolean quantity, boolean cost, boolean sales, boolean profit,
	...
	/*	AbstractColumn columnState = ColumnBuilder.getNew().setColumnProperty("state", String.class.getName())
			...
			.setTitle("Date").setWidth(new Integer(60))
			.setStyle(detailStyle).setHeaderStyle(headerStyle).build();
		
                        
                AbstractColumn columnShowProducts = ColumnBuilder.getNew()
                        .setColumnProperty("showProducts", String.class.getName())
			.setTitle("Products Sold").setWidth(new Integer(85))
			.setStyle(detailStyle).setHeaderStyle(headerStyle).build();
		...
		AbstractColumn columnProfit = ColumnBuilder.getNew()
                        .setColumnProperty("profits", Float.class.getName())
	...
	/*	GroupBuilder gb1 = new GroupBuilder();
		...
		DJGroup g2 = gb2.setCriteriaColumn((PropertyColumn) columnBranch    //and we add the same operations for the columnAmount and
			...
			.build(); */
                ...
                drb.addColumn(columnDate); //Cannot be removed
                ...
                if(name) drb.addColumn(columnShowProducts);
	...
	public static void main(String[] args) throws Exception {
		SalesByDateReport test = new SalesByDateReport();
		test.testReport();
