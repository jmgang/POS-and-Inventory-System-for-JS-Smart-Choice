...
public abstract class BaseSalesByDate extends TestCase {

	public Map getParams() {
		return params;
	}

	protected static final Log log = LogFactory.getLog(BaseSalesByDate.class);
	...
	protected JRDataSource getDataSource() {
		...
		Collection dummyCollection = Sales.getSalesByDate();
