...
public static void main(String arg[])
 {
 String arr[] = {"I", "Love", "Melrose", "Mellyace", "Mellycute", "Melroast"};
 ...
 JComboBox cBox= new AutoComplete(arr);
 ...
 items.add("Mellycute");
 items.add("Mellyaces");
 items.add("Mellychristmas");
 items.add("Merovingian");
 items.add("Spanish bread");
 items.add("Spanish computer");
